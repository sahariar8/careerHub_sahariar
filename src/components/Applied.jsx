...
const Applied = ({ job }) => {
  ...
  return (
    <div className="border p-10 rounded-lg flex">
      <div className="flex items-center bg-slate-100 p-20 rounded-lg">
        <img src={logo} alt="" className="w-[150px]" />
      </div>
      <div className="pl-20">
        <p className="text-xl font-semibold pt-4">{job_title}</p>
